...
import { buildMergeAnalysis } from './mergeAnalysis';
import type { MappedData } from './tagMapper';
import type { MatchPersonInput } from './matcher';
...
describe('buildMergeAnalysis', () => {
  it('classifies people and counts tiers', () => {
    ...
    const m = a.persons.find((p) => p.xref === '@I1@')!;
